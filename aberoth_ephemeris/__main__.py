...
if __name__ == "__main__":
    ...
    print(ephemeris.scrollEventsCache[0])
    print(ephemeris.scrollEventsCache[10])
    print(ephemeris.scrollEventsCache[-1])
    print(ephemeris.moonCyclesCache[0])
    print(ephemeris.moonCyclesCache[10])
    print(ephemeris.moonCyclesCache[-1])
    # import timeit
